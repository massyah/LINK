...
def plot_multiple_roc(rocList,title='',labels=None, include_baseline=False, equal_aspect=True,show=False):
...
class ROCData(object):
	...
	def plot(self,title='',include_baseline=False,equal_aspect=True,show=True):
